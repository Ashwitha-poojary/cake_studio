...
<div class="w3-main" style="margin-left:300px;margin-top:60px;">
  ...
  <li class="nav-item">
    <a class="nav-link " href="umanage.php">Users</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="amanage.php">Admin</a>
  </li>
</ul>
<header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i>Manage Admins</b></h5>
  </header>
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <?php if(($acomp['status']!=2) && ($acomp['id']!=$_COOKIE['admin'])){ ?>
      <button type="submit" class="btn btn-danger" name="adisable">Disable</button></form></div>
      <?php } ?>
      <?php if($acomp['status']==2){ ?>
      <button type="submit" class="btn btn-success" name="aenable" >Enable</button></form></div>
      <?php } ?>
      </form>
      </td>
      <?php  $i++; ?>
