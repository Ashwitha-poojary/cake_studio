...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="adashboard.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-home fa-fw"></i> Home </a>
...
<div class="w3-main" style="margin-left:300px;margin-top:60px;">
  ...
  <div class="container">
    <p><b>Hello <?php echo $apdisp['name'] ?>, Welcome to the admin dashboard of Cake Studio</b></p>
