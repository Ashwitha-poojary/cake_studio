...
<div class="w3-main" style="margin-left:300px;margin-top:60px;">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="#">Disabled Shops</a>
  </li>
</ul>
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <input type="hidden" name="eid" value="<?php echo $tab['id']; ?>">
      <button class="btn btn-success" name="enable" value="enable">Enable</button>
      </td>
      <?php  $i++; ?>
    </tr>
      <?php endforeach; ?>
