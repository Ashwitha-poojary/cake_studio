...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="shop.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i> Manage Shop </a>
...
<div class="w3-main" style="margin-left:300px;margin-top:60px;">
  ...
  <h1>Item List</h1>
    <div id="items" style="float: left; width:370px;max-height:800px;min-height:500px; margin:auto; padding:4px;">
        <h2><?php echo $lt['name'] ; ?></h2>
        <div>
        <?php echo "<img src='../../uploads/". $lt['item_img']." ' style='display: block;max-width:240px;max-height:240px;width: auto;height: auto;'>"; ?>
        </div>
        <h3>Description</h3>
        <small><?php echo $lt['descp']; ?></small>
        <h3>Price</h3>
        <p><?php echo $lt['price']; ?></p>
        <h3>Comments</h3>
        <div class="row " style="overflow:scroll;max-height:50em;width:90%;">
        <div class="col-md-12">
