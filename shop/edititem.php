...
require('../config/edititemconfig.php');
...
<div class="w3-main" style="margin-left:300px;margin-top:60px;">
  ...
  <header class="w3-container" style="margin:auto; padding-top:22px">
    <h2><b><i class="fa fa-users"></i> Edit Item</b></h2>
  </header>
  <div class="w3-container"  style="margin-left:35px" >
  <div class="col-md-9" id="form" style="margin:auto; float:left ; font-weight: bold; font-size:18px;">
  ...
  <div class="form-group">
      ...
      <input type="text" class="form-control" name="iname" id="iname"  value="<?php echo $list['name'];?>">
  </div>  
  <div class="form-row " >
  <label for="image">Item Image</label>
  </div>
  <div class="form-group">
  <?php echo "<img src='../uploads/". $list['item_img']." ' style='display: block;max-width:180px;max-height:180px;width: auto;height: auto;'>"; ?>
</div>
    <div class="form-group col-md-6" style="background-color:white;padding:0%;">      
      <input type="file" id="image" name="itimg" value="<?php echo $list['item_img'];?>" >   
  </div> 
  <div class="form-group">
    <label for="Description">Description</label>
    <textarea class="form-control" name="desc" id="Description" ><?php echo $list['descp'];?></textarea>
  </div>
    <div class="form-group">  
      <label for="price">Price</label>
      <input type="text" class="form-control" name="price" id="price" value="<?php echo $list['price'];?>">
    </div>
    <input type="hidden" name="itid" value="<?php echo $list['id'];?>">
  <button type="submit" value="submit" name="submit"  class="btn btn-primary btn-test">Submit</button>
 </form>
 </div>
 </div>
