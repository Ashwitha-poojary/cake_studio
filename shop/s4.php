...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="s4.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-diamond fa-fw"></i> New Orders</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:60px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h4><b><i class="fa fa-bell fa-fw "></i>New Orders</b></h4>
  </header>
    ...
    <?php foreach($list as $item): ?>
       <div id="items" style="border:solid 2px ;border-radius:10px;padding:2em;margin:2em;min-height:13em">
            <div class="float-lg-right">
                <form method="POST">
                  <button class="btn btn-primary" name="accept" value="accept">Accept Order?</button>
                  <br><br>
                  <input type="hidden" name="updateid" value="<?php echo $item['id'] ;?>" >
                  
                  </form>
                  <form method="POST">
                  <button class="btn btn-danger" name="delete" value="delete">Reject</button>
                  <br><br>
                  <input type="hidden" name="updateid" value="<?php echo $item['id'] ;?>" >
                </form>
                </div>
            
              <?php echo "<img src='../uploads/". $item['item_img']." ' style='display: block;max-width:15em;max-height:15em;width: auto;height: auto;padding-right:2em;'>"; ?>
              
                  <h3><?php echo $item['name']; ?></h3>
                  <small><?php echo $item['uname']; ?></small>
                  <h3>Quantity</h3>
