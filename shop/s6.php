...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="s6.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-history fa-fw"></i>  Deliver Items</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:60px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> Items to be delivered</b></h5>
  </header>
   ...
   <div id="items" style="border:solid 2px ;border-radius:10px;padding:2em;margin:2em;min-height:13em">
        ...
        <div >
          <?php echo "<img src='../uploads/". $view['item_img']." ' style='display: block;max-width:15em;max-height:15em;width: auto;height: auto;padding-right:2em;'>"; ?>
              ...
              <div>
              <button name="order" value="order" class="btn btn-sm btn-success " >Order Delivered</button>
              </div>
              </form>
              <br>
              <br>
