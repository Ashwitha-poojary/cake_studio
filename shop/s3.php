...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="s3.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  Add Products</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:60px;">
  ...
  <header class="w3-container" style="margin:auto; padding-top:22px">
    <h2><b><i class="fa fa-users"></i> Add Items</b></h2>
  </header>
  ...
  <label for="image">Item Image</label>
    ...
    <div class="form-group col-md-6" style="background-color:white;padding:0%;">      
      <input type="file" id="image" name="itimg" required>   
  </div> 
  <div class="form-group">
    ...
    <div class="form-group">  
      ...
      <input type="text" class="form-control" maxlength="5" name="price" id="price" required>
    </div>
