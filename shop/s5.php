...
require('../config/sorderconfig.php');
?>
<!DOCTYPE html>
<html>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="s5.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-bell fa-fw"></i>  Accepted Orders</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:60px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-bell"></i>Accepted Orders </b></h5>
  </header>

  <div class="w3-container"  style="margin:0.5em;" >

    <?php foreach($accept as $view): ?>
       <div id="items" style="border:solid 2px ;border-radius:10px;padding:2em;margin:2em;min-height:13em">
            ...
            <div >
              <?php echo "<img src='../uploads/". $view['item_img']." ' style='display: block;max-width:15em;max-height:15em;width: auto;height: auto;padding-right:2em;'>"; ?>
                  ...
                  <small><?php echo $view['addr']; ?></small><br>
                  <small><?php echo $view['phno']; ?></small>
                  <h3>Quantity</h3>
                  <small><?php echo $view['quantity']; ?>1</small>
                 
                  <?php if($view['srequest']!=""){ ?>
                      <h3>Request by Customer</h3>
                      <small><?php echo $view['srequest']; ?></small>
                  <?php  } ?>
                  <?php if($view['cust_img']!=""){ ?>
                    <h6> Cust image to be printed in cake</h6>
                    <div >
                     <?php echo "<img src='../uploads/". $view['cust_img']." ' style='display: block;max-width:15em;max-height:15em;width: auto;height: auto;padding-right:2em;'>"; ?>
                    </div>
                    <br>
                    <a href="<?php echo "../uploads/".$view['cust_img'] ; ?>" class="btn btn-primary">Download Image</a>
                    <br>
                  <?php } ?><br>
                  <h3>Status</h3>
                  <form method="POST">
                  ...
                  <div>
                  <button name="order" value="order" class="btn btn-sm btn-success " >Order Ready</button>
                  </div>
                  </form>
                  <br>
                  <br>
